...
const SCHOOL_CONFIG = {
  ...
  // Color Scheme
  primaryColor: "#28a745",      // Main brand color
  secondaryColor: "#1e7e34",    // Accent color
  ...
  emailSignature: `
    <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #eee;">
      ...
      <p>456 River Street, Riverside, RS 67890</p>
      <p>Phone: (555) 987-6543 | Email: admin@riversideacademy.edu</p>
      <p><a href="http://www.riversideacademy.edu">www.riversideacademy.edu</a></p>
    </div>
  `
};
    ...
    autoM8Footer.innerHTML = `
      ...
      ">
        <p style="margin: 0; opacity: 0.9;">
          Powered by <strong>AutoM8</strong>
        </p>
